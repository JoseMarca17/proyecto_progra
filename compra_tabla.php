...
//else
//{
    $sqlusu = mysqli_query($conn, "SELECT * FROM compra_prueba ORDER BY producto DESC LIMIT " . (($pagina - 1) * $filasmax)  . "," . $filasmax);
// }
 
    $resultadoMaximo = mysqli_query($conn, "SELECT count(*) as num_compra FROM compra_prueba"); 
