    ...
    <main>
        <div class="FormCajaLogin">
            ...
            <div class="FormLogin" style="text-align: center; display: flex; flex-direction: column; gap: 20px; align-items: center;">
                <a href="registros/registrar_usuario.php" class="BtnLogin">👤 Registrar Usuario</a>
                <a href="registros/registrar_producto.php" class="BtnLogin">📦 Registrar Producto</a>
                <a href="registros/registrar_compra.php" class="BtnLogin">🛒 Registrar Compra</a>
